...
namespace Cover.Backend.Entities
{
    public class CoverConfiguration
    {
        ...
        public CoverConfigurationType ConfigurationType { get; set; }
        ...
        public List<CoverConfigurationPrice> Prices { get; set; }
        ...
        public String StartDayName
        {
            get
            {
                if (!StartDay.HasValue)
                    return "";
                return WBM.Common.Helper.CommonFunctions.GetDayName(StartDay.Value);
            }
        }
        ...
        public String EndDayName
        {
            get
            {
                if (!EndDay.HasValue)
                    return "";
                return WBM.Common.Helper.CommonFunctions.GetDayName(EndDay.Value);
            }
        }
